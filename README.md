...
* Added DLC store links on vehicle pages (thanks to speedfreak975 for the idea).
...
* **Clickable Origin**: clicking the origin directs to the page from that country (thanks to Comfortably Numb for the idea).
* Added exceptions:
    * A:Level.
    * Đuro Đaković.
    * Konštrukta Trenčín.
